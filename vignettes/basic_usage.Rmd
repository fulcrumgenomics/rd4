...
median(d4source, "chr1", 17027500, 17027600)
...
```{r resample}
query_resample <- resample(d4source, "chr1", 17027500, 17027600, method = "mean", bin_size = 10)
...
```{r granges}
# Manually construct a GRanges object with the above genomic interval and one other interval
